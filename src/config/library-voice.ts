...
export const libraryVoice = {
  ...
  facets: {
    ...
    lead: "Each drawer opens as works are catalogued. Until then, the cards rest in order.",
    dormant: "Dormant — the archive awakens as works are filed",
    mediaType: libraryFields.medium,
    archivalStatus: libraryFields.archivalStatus,
    era: libraryFields.era,
...
export const libraryPublicationAliases = {
  ...
  libraryFiltersDormant: libraryVoice.facets.dormant,
  libraryFilterMediaType: libraryVoice.facets.mediaType,
  libraryFilterStatus: libraryVoice.facets.archivalStatus,
  libraryFilterDecade: libraryVoice.facets.era,
